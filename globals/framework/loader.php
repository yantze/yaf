...
function yaf_auto_load($classname)
{
    ...
    if ($namespace == 'Yaf' || stripos($namespace, 'Yaf'.$namespaceSeparator) === 0) {
        include_once(APPLICATION_PATH . '/globals/framework/Yaf_Namespace/G.php');
    ...
    if (file_exists(APPLICATION_PATH . '/globals/framework/' . $path )) {
        require_once(APPLICATION_PATH. '/globals/framework/' . $path);
    }
